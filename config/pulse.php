    ...
    */
    ...
    'recorders' => [
        ...
        Recorders\SlowOutgoingRequests::class => [
            ...
            'groups' => [
                '#^https://agent-as\.sentinel\.yamaseventynine\.com/api/monitors/response-code.*$#' => 'agent-as.sentinel.yamaseventynine.com/api/monitors/response-code*',
                '#^https://agent-eu\.sentinel\.yamaseventynine\.com/api/monitors/response-code.*$#' => 'agent-eu.sentinel.yamaseventynine.com/api/monitors/response-code*',
