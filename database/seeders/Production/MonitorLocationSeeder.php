...
class MonitorLocationSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        collect([
            ...
            ['name' => 'Asia',          'slug' => 'AS', 'agent_url' => "https://agent-as.{$monitorDomain}/api/monitors", 'is_active' => false, 'description' => 'Agent(s) found within the asian region'],
            ['name' => 'Europe',        'slug' => 'EU', 'agent_url' => "https://agent-eu.{$monitorDomain}/api/monitors", 'is_active' => false, 'description' => 'Agent(s) found within the european region'],
            ...
            MonitorLocation::updateOrCreate([
                'slug' => $data['slug'],
            ], array_merge($data, [
                // ...
            ]));
