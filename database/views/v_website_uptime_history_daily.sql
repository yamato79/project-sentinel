CREATE OR REPLACE VIEW v_website_uptime_history_daily AS
SELECT
    websites.website_id,
...
FROM
    (
        SELECT
            ...
            date_trunc('day'::text, monitor_queue.created_at) AS day_start,
        ...
        GROUP BY
            monitor_queue.website_id,
            date_trunc('day'::text, monitor_queue.created_at)
    ) subquery
